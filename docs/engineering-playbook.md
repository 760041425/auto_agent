...
| 算法 | 耗时 | 内点 | 重投影误差 | 质量门控 | quality_score |
|------|------|------|-----------|---------|---------------|
| SALAD+RoMa (原版) | 24.51s | 351 | 405.39px | ✗ FAIL | 3.96 |
| SALAD v2 (DISK+LG) | 3.24s | - | - | N/A | - |
| SALAD v2 + LoFTR | 15.98s | 204 | 103.92px | ✗ FAIL | 7.26 |
| Hybrid (联合) | 16.65s | 191 | 115.21px | ✗ FAIL | 7.26 |
| Multi-Strategy | 10.73s | 129 | 28.73px | ✗ FAIL | 4.49 |
