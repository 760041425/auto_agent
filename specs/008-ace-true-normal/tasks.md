...
| [ ] | TASK-008-02 | TASK-008-01 | 失败测试 TL-008-01：`estimate_normal` 接口+映射 | pytest red |
| [ ] | TASK-008-03 | TASK-008-02 | `services/localizer/normal_estimator.py`：DSINE/MiDaS 封装 + `(n+1)*0.5` 映射 + 懒加载 | pytest green（TL-008-01） |
| [ ] | TASK-008-04 | TASK-008-03 | 失败测试 TL-008-02：权重缺失回退常量 0.5 | pytest red |
| [ ] | TASK-008-05 | TASK-008-04 | 降级回退 + `normal_source` 标注 | pytest green（TL-008-02） |
| [ ] | TASK-008-06 | TASK-008-05 | 失败测试 TL-008-03：`normal_mode` 参数 + 6ch 真法线输入 | pytest red |
| [ ] | TASK-008-07 | TASK-008-06 | 接入 `ace_better`/`ace_normal`（`normal_mode`，6ch 路径） | pytest green（TL-008-03） |
